...
function SickCtrl($scope, $http) {
    ...
    // For choice 2 ~ 6 == SCI FI
    $http.get('/api/v1/movie/?genre=6&format=json&limit=75').
    ...
    // For choice 3 ~ 2 == War Movies
    $http.get('/api/v1/movie/?genre=2&format=json&limit=75').
