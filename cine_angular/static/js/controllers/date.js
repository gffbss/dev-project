...
function DateCtrl($scope, $http) {
    ...
    $http.get('/api/v1/movie/?genre=7&format=json&limit=40').
    ...
    $http.get('/api/v1/movie/?genre=15&format=json&limit=40').
    ...
    $http.get('/api/v1/movie/?genre=29&format=json&limit=40').
