...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genre.genre_api_id'
        db.add_column(u'cinema_genre', 'genre_api_id',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Movie.length'
        db.alter_column(u'cinema_movie', 'length', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Movie.trailer'
        db.alter_column(u'cinema_movie', 'trailer', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):
        # Deleting field 'Genre.genre_api_id'
        db.delete_column(u'cinema_genre', 'genre_api_id')


        # User chose to not deal with backwards NULL issues for 'Movie.length'
        raise RuntimeError("Cannot reverse this migration. 'Movie.length' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Movie.trailer'
        raise RuntimeError("Cannot reverse this migration. 'Movie.trailer' and its values cannot be restored.")
