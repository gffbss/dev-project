...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cinema_movie', 'poster',
                      self.gf('django.db.models.fields.files.ImageField')(default='cinema/static/img/no_poster.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.poster'
        db.delete_column(u'cinema_movie', 'poster')
