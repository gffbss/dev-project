...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Genre'
        db.create_table(u'cinema_genre', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('genre_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'cinema', ['Genre'])
        ...
        db.create_table(u'cinema_movie', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')(max_length=275)),
            ('genre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cinema.Genre'])),
            ('trailer', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'cinema', ['Movie'])

        # Adding model 'Rating'
        db.create_table(u'cinema_rating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('movie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cinema.Movie'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('match', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'cinema', ['Rating'])


    def backwards(self, orm):
        # Deleting model 'Genre'
        db.delete_table(u'cinema_genre')

        # Deleting model 'Movie'
        db.delete_table(u'cinema_movie')

        # Deleting model 'Rating'
        db.delete_table(u'cinema_rating')
    ...
    models = {
        ...
        u'cinema.movie': {
            ...
            'trailer': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
